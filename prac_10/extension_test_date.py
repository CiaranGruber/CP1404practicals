...
class Date:
    ...
    def add_days(self, days):
        ...
        >>> print(Date(1, 1, 1212).add_days(223134))
        Date: 29/11/1822
        """
    ...
    def is_leap_year(self):
        ...
        >>> print(Date(12, 12, 2004).is_leap_year())
        True
        """
...
if __name__ == '__main__':
    new_date = Date(12, 11, 2004)
    assert new_date.day == 12
    assert new_date.month == 11
    assert new_date.year == 2004
    doctest.testmod()
